...
HD_PWD='D:/NEW/TYUT/FPGA/Project/led_run/led_run.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_run_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_run_decoder.tcl -notrace
