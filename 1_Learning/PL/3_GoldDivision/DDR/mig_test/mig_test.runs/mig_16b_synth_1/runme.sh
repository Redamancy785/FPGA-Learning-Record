...
HD_PWD='D:/NEW/TYUT/FPGA/Code/1_Learning/PL/3_GoldDivision/DDR/mig_test/mig_test.runs/mig_16b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mig_16b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mig_16b.tcl
