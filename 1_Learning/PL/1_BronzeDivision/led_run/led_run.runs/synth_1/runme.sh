...
HD_PWD='D:/NEW/TYUT/FPGA/Project/led_run/led_run.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_run_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_run_decoder.tcl
