...
HD_PWD='D:/NEW/TYUT/FPGA/Project/3_GoldDivision/DDS/dds_ad9767/dds_ad9767.runs/triangular_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log triangular_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source triangular_rom.tcl
