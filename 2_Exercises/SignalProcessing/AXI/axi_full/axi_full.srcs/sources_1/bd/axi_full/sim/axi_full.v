...
//Command     : generate_target axi_full.bd
//Design      : axi_full
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "axi_full,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=axi_full,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "axi_full.hwdef" *) 
module axi_full
   (m00_axi_aclk_0,
    m00_axi_aresetn_0,
    m00_axi_init_axi_txn_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.M00_AXI_ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.M00_AXI_ACLK_0, ASSOCIATED_RESET m00_axi_aresetn_0, CLK_DOMAIN axi_full_m00_axi_aclk_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input m00_axi_aclk_0;
  ...
  axi_full_axi_full_0_0 axi_full_0
