...
-- Date        : Mon Mar 25 22:05:53 2024
-- Host        : DESKTOP-AJ2V9VE running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/NEW/TYUT/FPGA/Code/2_Exercises/SignalProcessing/GT/gt_transceiver/gt_transceiver.srcs/sources_1/ip/gtwizard_0_1/gtwizard_0_sim_netlist.vhdl
-- Design      : gtwizard_0
...
architecture STRUCTURE of gtwizard_0_gtwizard_0_sync_block_1 is
  ...
  attribute SOFT_HLUTNM of \mmcm_lock_count[7]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of mmcm_lock_reclocked_i_1 : label is "soft_lutpair16";
begin
data_sync_reg1: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
...
architecture STRUCTURE of gtwizard_0_gtwizard_0_RX_STARTUP_FSM is
  ...
  attribute SOFT_HLUTNM of \init_wait_count[6]_i_2__0\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of time_out_2ms_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \time_out_counter[0]_i_5\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of time_tlock_max_i_6 : label is "soft_lutpair10";
begin
  SR(0) <= \^sr\(0);
...
architecture STRUCTURE of gtwizard_0_gtwizard_0_TX_STARTUP_FSM is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_10\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_14\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_tx_state[3]_i_8\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \time_out_counter[0]_i_8\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \time_tlock_max_i_2__0\ : label is "soft_lutpair18";
...
entity gtwizard_0_gtwizard_0_init is
  ...
  attribute RX_CDRLOCK_TIME of gtwizard_0_gtwizard_0_init : entity is "32000.000000";
  ...
  attribute WAIT_TIME_CDRLOCK of gtwizard_0_gtwizard_0_init : entity is 3200;
...
entity gtwizard_0 is
  ...
  attribute X_CORE_INFO of gtwizard_0 : entity is "gtwizard_0,gtwizard_v3_6_10,{protocol_file=aurora_8b10b_single_lane_4byte}";
end gtwizard_0;
...
architecture STRUCTURE of gtwizard_0 is
  ...
  attribute WAIT_TIME_CDRLOCK : integer;
  attribute WAIT_TIME_CDRLOCK of inst : label is 3200;
begin
