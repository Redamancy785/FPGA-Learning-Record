...
HD_PWD='D:/NEW/TYUT/FPGA/Code/2_Exercises/SignalProcessing/AXI/axi_full/axi_full.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_full_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_full_top.tcl
