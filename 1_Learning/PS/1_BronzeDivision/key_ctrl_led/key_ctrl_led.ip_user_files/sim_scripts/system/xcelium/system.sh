...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../key_ctrl_led.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../key_ctrl_led.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../key_ctrl_led.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../key_ctrl_led.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../key_ctrl_led.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
       +incdir+"D:/NEW/TYUT/Vivado/Xilinx/Vivado/2018.3/data/xilinx_vip/include"
}
