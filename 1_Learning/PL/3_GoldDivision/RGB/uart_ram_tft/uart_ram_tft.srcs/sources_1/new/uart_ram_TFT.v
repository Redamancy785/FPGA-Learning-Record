...
//  output [15:0]visv_axis ;//显示的列坐标 
  ...
  uart_to_ram uart_to_ram(//将uart串口接收模块输出的数据写入ram中
   ...
   defparam  uart_to_ram.DISP_IMAGE_W     = 200;
    defparam  uart_to_ram.DISP_IMAGE_H    = 200; 
 ...
 wire  [11:0]visv_axis ;
  ...
  ram_to_display ram_to_display(//读ram数据到显示屏模块
    ...
    defparam  ram_to_display.DISP_IMAGE_W    = 200;
    defparam  ram_to_display.DISP_IMAGE_H    = 200;
