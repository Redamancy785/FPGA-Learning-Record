...
HD_PWD='D:/NEW/TYUT/FPGA/Code/1_Learning/PL/2_SilverDivision/ÊýÂë¹ÜÏÔÊ¾/digital_tube_hc595/digital_tube_hc595.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_tube_hc595.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source digital_tube_hc595.tcl
