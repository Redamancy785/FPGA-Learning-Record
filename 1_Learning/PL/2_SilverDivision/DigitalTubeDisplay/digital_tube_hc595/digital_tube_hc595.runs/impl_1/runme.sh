...
HD_PWD='D:/NEW/TYUT/FPGA/Code/1_Learning/PL/2_SilverDivision/DigitalTubeDisplay/digital_tube_hc595/digital_tube_hc595.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_tube_hc595.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_tube_hc595.tcl -notrace
