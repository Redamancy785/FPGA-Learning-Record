...
HD_PWD='D:/NEW/TYUT/FPGA/Code/3_Test/ch34_acz7015_rom_image_tft_hdmi800x480/rom_image_tft_hdmi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_image_tft_hdmi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_image_tft_hdmi.tcl
