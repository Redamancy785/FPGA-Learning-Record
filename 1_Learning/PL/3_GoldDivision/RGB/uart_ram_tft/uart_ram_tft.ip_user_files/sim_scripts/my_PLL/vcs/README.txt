...
#
# Generated by export_simulation on Fri Mar 29 19:32:27 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './my_PLL.sh' script.
...
./my_PLL.sh -noclean_files

For more information on the script, please type './my_PLL.sh -help'.
