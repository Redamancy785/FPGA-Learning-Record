...
set rc [catch {
  ...
  add_files -quiet D:/NEW/TYUT/FPGA/Code/1_Learning/PS/1_BronzeDivision/gpio_interrupt/gpio_interrupt.runs/synth_1/system_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top system_wrapper -part xc7z015clg485-2
  set_param project.isImplRun false
