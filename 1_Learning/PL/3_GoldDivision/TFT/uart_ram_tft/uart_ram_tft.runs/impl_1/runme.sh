...
HD_PWD='D:/NEW/TYUT/FPGA/Code/1_Learning/PL/3_GoldDivision/TFT/uart_ram_tft/uart_ram_tft.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_ram_TFT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_ram_TFT.tcl -notrace
