...
HD_PWD='D:/NEW/TYUT/FPGA/Code/1_Learning/PL/3_GoldDivision/RGB/uart_ram_tft/uart_ram_tft.runs/RAM_DISPLAY_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM_DISPLAY.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM_DISPLAY.tcl
